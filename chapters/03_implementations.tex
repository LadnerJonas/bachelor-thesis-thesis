...
\begin{table}[h]
  ...
  \begin{tabular}{|p{0.19\textwidth}|p{0.40\textwidth}|p{0.30\textwidth}|}
    ...
    Radix                        & Pre-allocate pages using global histogram, write independently                                 & Synchronisation required when creating global histogram, during page allocation and distribution \\\hline
    Hybrid                       & Pre-allocate pages using thread-local histogram, write independently                           & Synchronisation required during page allocation and distribution                                 \\\hline
